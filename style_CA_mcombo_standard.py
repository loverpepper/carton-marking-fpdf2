...
class MComboStandardStyle(BoxMarkStyle):
    ...
    def _draw_flap_left(self, pdf: FPDF, sku_config,
        ...
        size_sku_pt, pil_sku_font = self._get_font_size(sku_config.sku_name, 'AvantGardeLT-Demi', icon_w_mm * 0.8, ppi=sku_config.ppi)
        ...
        main_col = engine.Column(
            children = [engine.Image(icon, width = icon_w_mm, height=icon_h_mm), 
                      sku_elem],
            fixed_height= h_mm,
            fixed_width= w_mm,
            align='center',
